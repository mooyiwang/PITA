...
class ArgMiningDataset(Dataset):
    ...
    def __init__(self, data_df, config):
        ...
        self.AR_link_list = [eval(_) for _ in data_df['ac_rel_targets']]
        ...
        self.para_text_list = para_text_list #
    ...
    def __getitem__(self, index):
        one_sample = (
            ...
            self.AR_link_list[index],
            self.AR_link_types_list[index],
            self.para_text_list[index],
        )
        return one_sample
...
def generate_batch_fn(batch):
    ...
    batch = {
        ...
        'true_AR_link': batch[5],
        'true_AR_link_types': batch[6],
        'para_texts': batch[7],
    }
    return batch
...
if __name__ == '__main__':
    ...
    data_path = './data/pe/pe_data_df_graphs2.csv'
